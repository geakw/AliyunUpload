...
public class PutObjectRequest extends OSSRequest {
	...
	/**
	 * 构造上传文件请求
	 * @param url 上传到Bucket的名字
	 * @param objectKey 上传到OSS后的ObjectKey
	 * @param uploadFilePath 上传文件的本地路径
	 */
    public PutObjectRequest(String url, String objectKey, String uploadFilePath) {
        this.url = url;
	 ...
	 */
    public PutObjectRequest(String url, String objectKey, String uploadFilePath, ObjectMetadata metadata) {
        this.url = url;
        this.objectKey = objectKey;
		this.uploadFilePath = uploadFilePath;
	 ...
	 */
	public PutObjectRequest(String url, String objectKey, byte[] uploadData) {
		this.url = url;
		this.objectKey = objectKey;
	 ...
	 * @param metadata 设置上传文件的元信息
	 */
	public PutObjectRequest(String url, String objectKey, byte[] uploadData, ObjectMetadata metadata) {
		this.url = url;
		this.objectKey = objectKey;
		this.uploadData = uploadData;
		this.metadata = metadata;
