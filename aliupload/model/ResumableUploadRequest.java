...
import com.eastmoney.video.network.aliupload.common.OSSConstants;
...
public class ResumableUploadRequest extends OSSRequest {
    ...
    /**
     * 构造新的断点上传请求
     * @param url 上传到的Bucket名
     * @param objectKey 上传的Object名
     * @param uploadFilePath 上传本地文件的路径
     */
    public ResumableUploadRequest(String url, String objectKey, String uploadFilePath) {
        this.url = url;
     ...
     */
    public ResumableUploadRequest(String url, String objectKey, String uploadFilePath, ObjectMetadata metadata) {
        this.url = url;
        this.objectKey = objectKey;
        this.uploadFilePath = uploadFilePath;
     ...
     */
    public ResumableUploadRequest(String url, String objectKey, String uploadFilePath, String recordDirectory) {
        this.url = url;
        this.objectKey = objectKey;
        this.uploadFilePath = uploadFilePath;
     ...
     * @param recordDirectory 断点记录文件的保存位置，需是一个文件夹的绝对路径
     */
    public ResumableUploadRequest(String url, String objectKey, String uploadFilePath, ObjectMetadata metadata, String recordDirectory) {
        this.url = url;
        this.objectKey = objectKey;
        this.uploadFilePath = uploadFilePath;
        this.metadata = metadata;
